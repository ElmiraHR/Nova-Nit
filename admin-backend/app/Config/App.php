...
class App extends BaseConfig
{
    ...
    {
        // ✅ Используем API_URL из .env или дефолтный URL
 ...
 * --------------------------------------------------------------------------
 *
 * 'sessionDriver' = The storage driver to use: files, database, redis, etc.
 ...
 * 'sessionSavePath' = The location to save sessions. For 'files' driver, it's a path.
